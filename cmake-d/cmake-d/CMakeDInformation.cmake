...
if(NOT CMAKE_D_COMPILE_OPTIONS_PIC)
   set(CMAKE_DCOMPILE_OPTIONS_PIC ${CMAKE_C_COMPILE_OPTIONS_PIC})
endif()

if(NOT CMAKE_D_COMPILE_OPTIONS_PIE)
   set(CMAKE_D_COMPILE_OPTIONS_PIE ${CMAKE_C_COMPILE_OPTIONS_PIE})
endif()

if(NOT CMAKE_D_COMPILE_OPTIONS_DLL)
   set(CMAKE_D_COMPILE_OPTIONS_DLL ${CMAKE_C_COMPILE_OPTIONS_DLL})
endif()
...
if(NOT DEFINED CMAKE_EXE_EXPORTS_D_FLAG)
  set(CMAKE_EXE_EXPORTS_D_FLAG ${CMAKE_EXE_EXPORTS_C_FLAG})
endif()

if(NOT DEFINED CMAKE_SHARED_LIBRARY_SONAME_D_FLAG)
   set(CMAKE_SHARED_LIBRARY_SONAME_D_FLAG ${CMAKE_SHARED_LIBRARY_SONAME_C_FLAG})
endif()
...
# Initialize D link type selection flags from C versions.
foreach(type SHARED_LIBRARY SHARED_MODULE EXE)
  if(NOT CMAKE_${type}_LINK_STATIC_D_FLAGS)
    set(CMAKE_${type}_LINK_STATIC_D_FLAGS
      ${CMAKE_${type}_LINK_STATIC_C_FLAGS})
  endif()
  if(NOT CMAKE_${type}_LINK_DYNAMIC_D_FLAGS)
    set(CMAKE_${type}_LINK_DYNAMIC_D_FLAGS
